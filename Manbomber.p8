...
spawns = {{x=3,y=4},{x=13,y=14},{x=3,y=14},{x=13,y=4},{x=8,y=10}}
...
function _Timer:draw()
    if (mainScene.playerCount >= 5) return
    --draw watch
    spr(136,61,3)
    --draw background
    spr(166,55,10,2.5,1)
...
function _selectionScene:update()
	...
	if btnpOnAny(⬇️) and self.cursorPos < 3 then 
		sfx(04)
		self.cursorPos += 1
    end
    if btnpOnAny(❎) then 
...

